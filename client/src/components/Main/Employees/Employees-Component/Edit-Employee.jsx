...
export default function EditEmployee({ employee, toggleModal }) {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            const body = { user_id: employee.user_id, firstName, lastName, email, role, payGrade, phone, position }
                ...
                >
                    ...
                    >
                        ...
                        <div className='grid grid-cols-2 gap-3'>
                            ...
                            <div className="flex flex-col gap-1">
                                <label className="text-sm text-gray-700">Pay Grade</label>
                                <select
                                    onChange={(e) => setPayGrade(parseInt(e.target.value))}
                                    value={payGrade}
                                    required 
                                    className="border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:border-black bg-white cursor-pointer"
                                >
